import { PageType, AlbumType, } from './models.js';
...
export const parseMusicItem = (content) => {
    ...
    try {
        thumbnailUrl =
            (_a = content.musicResponsiveListItemRenderer.thumbnail.musicThumbnailRenderer.thumbnail.thumbnails.pop()) === null || _a === void 0 ? void 0 : _a.url;
    }
    catch (err) { }
    let duration;
    try {
...
export const parseSuggestionItem = (content) => {
    ...
    try {
        thumbnailUrl =
            (_a = content.playlistPanelVideoRenderer.thumbnail.thumbnails.pop()) === null || _a === void 0 ? void 0 : _a.url;
    }
    catch (err) { }
    let duration;
    try {
...
export const parsePlaylistItem = (content, onlyOfficialPlaylists) => {
    var _a;
    let playlistId;
    try {
        playlistId =
...
export const parseAlbumItem = (content) => {
    ...
    let type;
    try {
        type = getAlbumType(content.musicResponsiveListItemRenderer.flexColumns[1]
            .musicResponsiveListItemFlexColumnRenderer.text.runs[0].text);
    }
    catch (err) {
...
export const parseAlbumHeader = (content) => {
    ...
    try {
        thumbnailUrl =
            (_a = content.musicDetailHeaderRenderer.thumbnail.croppedSquareThumbnailRenderer.thumbnail.thumbnails.pop()) === null || _a === void 0 ? void 0 : _a.url;
    }
    catch (err) {
...
export const parseMusicInAlbumItem = (content) => {
    ...
    try {
        if ((_a = content.musicResponsiveListItemRenderer.flexColumns[1]) === null || _a === void 0 ? void 0 : _a.musicResponsiveListItemFlexColumnRenderer.text.runs)
            for (let i = 0; i <
                content.musicResponsiveListItemRenderer.flexColumns[1]
                    .musicResponsiveListItemFlexColumnRenderer.text.runs.length; i += 2) {
                artists.push({
...
export const parseArtistsAlbumItem = (item) => {
    ...
    try {
        thumbnailUrl =
            (_b = item.musicTwoRowItemRenderer.thumbnailRenderer.musicThumbnailRenderer.thumbnail.thumbnails.shift()) === null || _b === void 0 ? void 0 : _b.url;
    }
    catch (e) {
...
const parseArtistsSuggestionsItem = (item) => {
    ...
    try {
        thumbnailUrl =
            (_a = item.musicTwoRowItemRenderer.thumbnailRenderer.musicThumbnailRenderer.thumbnail.thumbnails.pop()) === null || _a === void 0 ? void 0 : _a.url;
    }
    catch (e) {
        console.error("Couldn't get thumbnailUrl", e);
    }
...
export const parseArtistData = (body, artistId) => {
    var _a, _b;
    let name;
    try {
    ...
    const thumbnails = [];
    try {
        const thumbnailArray = body.header.musicImmersiveHeaderRenderer.thumbnail.musicThumbnailRenderer
    ...
    const singles = [];
    try {
        const { contents } = body.contents.singleColumnBrowseResultsRenderer.tabs[0].tabRenderer
            .content.sectionListRenderer;
        for (const shelf of contents) {
            if ((_a = shelf.musicCarouselShelfRenderer) === null || _a === void 0 ? void 0 : _a.contents) {
                if (((_b = shelf.musicCarouselShelfRenderer.contents[0].musicTwoRowItemRenderer
                    .title.runs[0].navigationEndpoint) === null || _b === void 0 ? void 0 : _b.browseEndpoint.browseEndpointContextSupportedConfigs.browseEndpointContextMusicConfig.pageType) === PageType.album)
    ...
    try {
        ...
        for (let i = contents.length - 1; i >= 0; i -= 1) {
            if (contents[i].musicCarouselShelfRenderer) {
                if (contents[i].musicCarouselShelfRenderer.contents[0]
